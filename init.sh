...
sequelize model:generate --name User --attributes username:string,password:string,firstname:string,name:string,id_location:integer,job:string,email:string,birth:date,description:text,url_illustration:string
...
sequelize model:generate --name FileAttachment --attributes type:string,id_user:integer,url_storage:string
